"""
Django settings for dulcedamor project.
...
SECRET_KEY = 'django-insecure-$cj=)nnlkoa!v8#5j-ke$@0f33nt5o2=j5je^-s6g2dsl)a&49'
...
# Aquí indicamos a Django que use el modelo CustomUser
...
WSGI_APPLICATION = 'dulcedamor.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'inventario_final',                # Nombre de la base de datos
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    },
    {
        ...
        'OPTIONS': {
            'min_length': 8,  # Cambia este valor si necesitas una longitud diferente
        }
    },
    {
...
# Carpetas donde buscar archivos estáticos en desarrollo
STATICFILES_DIRS = [
    BASE_DIR / "static",
]

# Ruta para los archivos estáticos recolectados
